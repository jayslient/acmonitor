...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Apinform',
            fields=[
                ('ap_oid', models.CharField(max_length=24, serialize=False, primary_key=True)),
                ('ap_mac', models.CharField(max_length=12, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ap_oid', models.CharField(max_length=24, null=True, blank=True)),
